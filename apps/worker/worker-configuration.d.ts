/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9a0a1b9d18080c48fd61ee83c77961a4)
// Runtime types generated with workerd@1.20260921.1 2026-08-01 
interface __BaseEnv_Env {
	DB: D1Database;
	AUTH_MAILER: SendEmail;
	BIZ_MAILER: SendEmail;
	MAIL_FEEDBACK_QUEUE: Queue;
	PIPELINE_DO: DurableObjectNamespace<import("./src/index").PipelineDO>;
	DELIVERY_DO: DurableObjectNamespace<import("./src/index").DeliveryDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PipelineDO" | "DeliveryDO";
	}
